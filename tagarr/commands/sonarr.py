...
@app.command(help="Tag TV shows in Sonarr with their streaming provider names")
def tag(
...
@app.command(help="Remove stale streaming provider tags from series in Sonarr")
def clean(
    providers: Optional[List[str]] = typer.Option(
        None,
        "-p",
